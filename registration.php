        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">Prodance</small></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    <p><i class="fa fa-users fa-5x"></i></p>
                    <p class="lead">
                        Al registrarse recibira notificaciones de nuestras ofertas más recientes en nuestra compañia.
                    </p>
                    <br>
                    <img src="assets/img/img.jpg" alt="electrodomesticos" class="img-responsive">
                </div>
