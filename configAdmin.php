    ...
    <section id="prove-product-cat-config">
        <div class="container">
            ...
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li role="presentation"><a href="#Prod" role="tab" data-toggle="tab">Chambelan</a></li>
            ...
            <div class="tab-content">
                ...
                <div class="row">
                            ...
                            <form role="form" action="process/regproduct.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" name="prod-categoria">
                                    <?php
                                        $categoriac=  ejecutarSQL::consultar("select * from categoria  where CodigoCat!='C4'");
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="del-prod-form">
                            <h2 class="text-danger text-center"><small><i class="fa fa-trash-o"></i></small>&nbsp;&nbsp;Eliminar paquete</h2>
                             <form action="process/delprod.php" method="post" role="form">
                                 <div class="form-group">
                                     <label>Paquete</label>
                                     <select class="form-control" name="prod-code">
                                         <?php
                                             $productoc=  ejecutarSQL::consultar("select * from producto where CodigoCat!='C4'");
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading text-center"><i class="fa fa-refresh fa-2x"></i><h3>Actualizar datos de paquete</h3></div>
                          <div class="table-responsive">
                              <table class="table table-bordered">
                                  ...
                                  <tbody>
                                      <?php
                                        $productos=  ejecutarSQL::consultar("select * from producto where CodigoCat!='C4'");
                                        $upr=1;
                ...
                <!--==============================Panel Proveedores===============================-->
                <!--==============================Panel productos===============================-->
                <div role="tabpanel" class="tab-pane fade in " id="Prod">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <br><br>
                        <div id="add-product">
                                  ...
                                  <tbody>
                                      <?php
                                        ...
                                        while($prod=mysql_fetch_array($productos)){
                                            echo '
                                                <div id="update-product">
                                                  <form method="post" action="process/actualizacham.php" id="res-update-product-'.$upr.'">
                                                    <tr>
                                                        <td>
                                                          <input class="form-control" type="hidden" name="code-old-prod" required="" value="'.$prod['CodigoProd'].'">
                                                          <input class="form-control" type="text" name="code-prod" maxlength="30" required="" value="'.$prod['CodigoProd'].'">
