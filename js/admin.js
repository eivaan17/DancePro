$(document).ready(function() {
    ...
    $('#del-prod-form form').submit(function(e) {
         ...
         $.ajax({
            ...
            data:informacion,
            beforeSend: function(){
                $("#res-form-del-prod").html('Eliminando paquete <br><img src="assets/img/enviando.gif" class="center-all-contens">');
            },
            error: function() {
    ...
    $('#add-provee form').submit(function(e) {
         ...
         $.ajax({
            ...
            data:informacion,
            beforeSend: function(){
                $("#res-form-add-prove").html('Agregando chambelan <br><img src="assets/img/enviando.gif" class="center-all-contens">');
            },
            error: function() {
    ...
    $('#del-prove form').submit(function(e) {
         ...
         $.ajax({
            ...
            data:informacion,
            beforeSend: function(){
                $("#res-form-del-prove").html('Eliminando chambelan <br><img src="assets/img/enviando.gif" class="center-all-contens">');
            },
            error: function() {
