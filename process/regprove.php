...
if(!$nitProve=="" && !$nameProve=="" && !$dirProve=="" && !$telProve==""  ){
    ...
    if($verificaltotal<=0){
        if(consultasSQL::InsertSQL("proveedor", "NITProveedor, NombreProveedor, Direccion, Telefono, PaginaWeb", "'$nitProve','$nameProve','$dirProve','$telProve','f'")){
            echo '<img src="assets/img/correcto.png" class="center-all-contens"><br><p class="lead text-center">chambelan añadido éxitosamente</p>';
        }else{
